...
function caseUp($icon) {
  ...
  // 2. up 또는  down 요소에 애니메이션 넣을 것. .selected를 추가해서.
  ...
  // 삭제되는 요소가 1번 아이콘인 경우 이전 요소가 없기 때문에 $delTarget이 null이 됩니다.
...
function caseDown($icon) {
  ...
  // 2. #down 요소의 .selected를 추가, #up을 제거
...
export {caseUp, caseDown, correntAnswer};